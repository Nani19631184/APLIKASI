...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      LAPORAN
      <small>Laporan Penyaluran Zakat</small>
    </h1>
    <ol class="breadcrumb">
      ...
      <section class="col-lg-12">
              ...
              <div class="row">
                ...
                <div class="form-group">
                    ...
                    <select name="penyuluh" class="form-control" required="required">
                      <option value="semua">- Semua penyuluh -</option>
                      <?php 
        ...
        <div class="box-body">
            ...
            if(isset($_GET['tanggal_sampai']) && isset($_GET['tanggal_dari']) && isset($_GET['penyuluh'])){
              ...
              <a href="laporan_print.php?tanggal_dari=<?php echo $tgl_dari ?>&tanggal_sampai=<?php echo $tgl_sampai ?>&penyuluh=<?php echo $penyuluh ?>" target="_blank" class="btn btn-sm btn-primary"><i class="fa fa-print"></i> &nbsp PRINT</a>
