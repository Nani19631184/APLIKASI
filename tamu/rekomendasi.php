  ...
  <section class="content">
    <div class="row">
      <section class="col-lg-12">
        ...
        <h4 class="text-black">Klik tombol "TAMBAH DATA" untuk mendaftar pengajuan rekomendasi nikah. Isi data dan upload file sesuai ketentuan pendaftaran<br>
                 ...
                 <?php 
                  include '../koneksi.php';
                    ...
                    <tr>
                      ...
                      <td class="text-center"><button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#lihat_rekomendasi_<?php echo $d['rekomendasi_id'] ?>">Lihat File</a></td>
                          ...
                          <div class="modal fade" id="lihat_rekomendasi_<?php echo $d['rekomendasi_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <embed src="../gambar/bukti/<?php echo $d['rekomendasi_foto']; ?>" type="application/pdf" width="100%" height="400px" />
                                </div>
                                <div class="modal-footer">
                                  <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                                </div>
