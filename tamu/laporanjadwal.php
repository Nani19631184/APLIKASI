  ...
  <section class="content">
    <div class="row">
      <section class="col-lg-12">
        ...
        <div class="box box-info">
          <div class="box-header">
            <h3 class="box-title">Laporan Jadwal Nikah </h3>
          </div>
        <div class="box-body">
            ...
            if(isset($_GET['tanggal_sampai']) && isset($_GET['tanggal_dari'])){
              ...
              <a href="laporanjadwal_print.php?tanggal_dari=<?php echo $tgl_dari ?>&tanggal_sampai=<?php echo $tgl_sampai ?>" target="_blank" class="btn btn-sm btn-primary"><i class="fa fa-print"></i>  &nbsp PRINT</a>
              <div class="table-responsive">
                ...
                <tbody>
                    ...
                    $no=1;                
                      ...
                      $data = mysqli_query($koneksi,"SELECT * FROM jadwal,penghulu where penghulu.penghulu_id=jadwal.penghulu and username='".$_SESSION['username']."' and date(jadwal_tanggal)>='$tgl_dari' and date(jadwal_tanggal)<='$tgl_sampai'");
