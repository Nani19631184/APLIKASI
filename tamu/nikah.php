  ...
  <section class="content">
    <div class="row">
      <section class="col-lg-12">
        ...
        <h4 class="text-black">Klik tombol "TAMBAH DATA" untuk melakukan pendaftaran nikah. Isi data dan upload file sesuai ketentuan pendaftaran<br>
Setelah selesai mendaftar dan status pendaftaran berubah menjadi "Pengajuan Disetujui" silahkan daftarkan tanggal akad nikah anda pada laman Jadwal Nikah</h4>
          </div>
              ...
              <table class="table table-bordered table-striped" id="table-datatable">
                ...
                <thead>
                  ...
                  <th width="1%" >NO</th>
                    ...
                    <th  width="13%" class="text-center">UBAH DATA</th>
                  </tr>
                </thead>
                 <tbody>
                  <?php 
                  ...
                  $sql = "SELECT * FROM nikah,penghulu WHERE penghulu.penghulu_id=nikah.penghulu and username='".$_SESSION['username']."'";
                  ...
                  while ($d = mysqli_fetch_array($data)) {
                   ?>
                    <tr>
                      ...
                      <td><button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#lihat_nikah_<?php echo $d['nikah_id'] ?>">Lihat File</a></td>
                            ...
                            <div class="modal-content">
                              ...
                              <div class="form-group" style="width:100%;margin-bottom:20px">
                                ...
                                <div class="form-group" style="width:100%;margin-bottom:20px">
                                    ...
                                    <!-- <small><?php echo $d['nikah_foto'] ?></small> -->
                                    <p class="help-block">Bila File <?php echo "<a class='fancybox btn btn-xs btn-primary' target=_blank href='../gambar/bukti/$d[nikah_foto]'>$d[nikah_foto]</a>";?> tidak dirubah kosongkan saja</p>
                                  </div>
